package com.trian0.nearby.ui.components.button
...
import com.trian0.nearby.ui.theme.GreenBase
...
fun NearbyButton(
    ...
    Button(
        ...
        Row(
            ...
            iconRes?.let {
                Icon(painter = painterResource(id = it), contentDescription = "Ícone do Botão")
            }
            text?.let {
                Text(text = it.uppercase(), style = Typography.labelLarge)
            }
        }
    }
}
